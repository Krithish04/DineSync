...
// Module resolver hook to resolve backend dependencies
...
Module.prototype.require = function (id) {
  try {
    ...
    if (err.code === 'MODULE_NOT_FOUND' && !id.startsWith('.') && !id.startsWith('/')) {
      const backendModulePath = path.join(backendDir, 'node_modules', id);
...
const env = require('../backend/src/config/env.config');
const aiService = require('../backend/src/features/ai/ai.service');
const Restaurant = require('../backend/src/features/restaurant/restaurant.model');
